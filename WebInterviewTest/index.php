			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-5 padded-text">
						...
						<p class="button-row">
						<p>&nbsp;</p>
				      <a href="https://play.google.com/store/apps/details?id=com.ekoapp.loop&hl=en" target="_blank" button type="button" class="btn btn-default btn-store"> Download For Free</a>
					</p>
					</div>
